...
if __name__ == '__main__':
    ...
    model_lighting = Prediction_Temperature_LightningModule(paras=paras_Prediction_Temperature)
    ...
    trainer = pl.Trainer(log_every_n_steps=1, max_epochs=paras_Prediction_Temperature['max_epochs'], check_val_every_n_epoch=1,
    ...
    trainer.fit(model=model_lighting, train_dataloaders=paras_Prediction_Temperature_dataset['dataset_loader_train'],
                val_dataloaders=paras_Prediction_Temperature_dataset['dataset_loader_val'])
